...
<div class="mc-demo">
  <mc-skin-viewer style="width: 64px; height: 128px;" />
</div>
...
<div class="mc-demo">
  <mc-list :items="[{label:'列表项一',value:'a'},{label:'列表项二',value:'b'},{label:'列表项三',value:'c'}]" />
</div>
...
<div class="mc-demo">
  <mc-scroll-view style="width: 240px; height: 100px;">
    <mc-list :items="[
      {label:'世界一 · 生存模式',value:'w1'},
      {label:'世界二 · 创造模式',value:'w2'},
      {label:'世界三 · 冒险模式',value:'w3'},
      {label:'世界四 · 服务器',value:'w4'},
      {label:'世界五 · 测试存档',value:'w5'},
    ]" />
  </mc-scroll-view>
</div>
